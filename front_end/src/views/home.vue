<script setup>
  ...
  const fileList = ref([
    ...
    //文件夹
    const list=ref([
      {listName:'20240821',pictureList:[{url:userPic1,name:'name',size:1000000,time:1635475483259,sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:2000000,time:1709452800000,sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:3000000,time:1672527600000,sort:['胡桃','海报','原神','启动']},{url:userPic1,name:'name',size:'200MB',time:'2024/08/21',sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:'300MB',time:'2024/08/22',sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:'400MB',time:'2024/08/23',sort:['胡桃','海报','原神','启动']},{url:userPic1,name:'name',size:'200MB',time:'2024/08/21',sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:'300MB',time:'2024/08/22',sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:'400MB',time:'2024/08/23',sort:['胡桃','海报','原神','启动']},{url:userPic1,name:'name',size:'200MB',time:'2024/08/21',sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:'300MB',time:'2024/08/22',sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:'400MB',time:'2024/08/23',sort:['胡桃','海报','原神','启动']}]},
      {listName:'20240822',pictureList:[{url:userPic1,name:'name',size:1000000,time:1635475483259,sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:2000000,time:1709452800000,sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:3000000,time:1672527600000,sort:['胡桃','海报','原神','启动']}]},
      {listName:'20240823',pictureList:[{url:userPic1,name:'name',size:1000000,time:1635475483259,sort:['八重','狐狸','好看','原神','启动']},{url:userPic2,name:'name2',size:2000000,time:1709452800000,sort:['胡桃','堂主','可爱','原神','启动']},{url:userPic3,name:'name3',size:3000000,time:1672527600000,sort:['胡桃','海报','原神','启动']}]}
    ])
